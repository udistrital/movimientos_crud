...
func (m *CrearTablasMovimientos_20190621_032023) Up() {
	m.SQL(" CREATE SEQUENCE movimientos.movimiento_id_seq " +
		...
		"NO CYCLE " +
		"OWNED BY NONE ")
	m.SQL("ALTER SEQUENCE movimientos.movimiento_id_seq OWNER TO desarrollooas;")
	...
	m.SQL("ALTER TABLE movimientos.movimiento_proceso_externo OWNER TO desarrollooas")
	m.SQL("CREATE SEQUENCE movimientos.movimiento_detalle_id_seq " +
		...
		"NO CYCLE " +
		"OWNED BY NONE;")
	m.SQL("ALTER SEQUENCE movimientos.movimiento_detalle_id_seq OWNER TO desarrollooas")
	...
	m.SQL("ALTER TABLE movimientos.movimiento_detalle OWNER TO desarrollooas")
	m.SQL("CREATE SEQUENCE movimientos.tipo_movimiento_id_seq " +
		...
		"NO CYCLE " +
		"OWNED BY NONE; ")
	m.SQL("ALTER SEQUENCE movimientos.tipo_movimiento_id_seq OWNER TO desarrollooas;")
	...
	m.SQL("ALTER TABLE movimientos.tipo_movimiento OWNER TO desarrollooas;")

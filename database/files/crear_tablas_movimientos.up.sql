CREATE TABLE movimientos.movimiento (
	id serial NOT NULL,
	nombre varchar(20) NOT NULL,
	descripcion varchar,
	tipo_movimiento_id int4 NOT NULL,
	proceso_externo int8 NOT NULL,
	CONSTRAINT pk_movimiento PRIMARY KEY (id)

);
-- ddl-end --
COMMENT ON TABLE movimientos.movimiento IS 'Entidad que identifica todos los  diferentes movimientos para procesos externos';
-- ddl-end --
COMMENT ON COLUMN movimientos.movimiento.id IS 'identificador de la tabla movimiento_proceso_externo';
-- ddl-end --
COMMENT ON COLUMN movimientos.movimiento.nombre IS 'nombre del proceso';
-- ddl-end --
COMMENT ON COLUMN movimientos.movimiento.descripcion IS 'Descripción del proceso externo';
-- ddl-end --
COMMENT ON COLUMN movimientos.movimiento.tipo_movimiento_id IS 'campo que relaciona a la tabla de tipo de movimiento';
-- ddl-end --
COMMENT ON COLUMN movimientos.movimiento.proceso_externo IS 'identificador del proceso al que hace referencia este movimiento, por ejemplo apropiaciones, adiciones, traslados, suspensiones, etc';
-- ddl-end --
COMMENT ON CONSTRAINT pk_movimiento ON movimientos.movimiento  IS 'Llave primaria de la entidad movimiento';
-- ddl-end --
ALTER TABLE movimientos.movimiento OWNER TO test;
-- ddl-end --
...
-- ALTER TABLE movimientos.movimiento DROP CONSTRAINT IF EXISTS fk_movimiento_tipo_movimiento CASCADE;
ALTER TABLE movimientos.movimiento ADD CONSTRAINT fk_movimiento_tipo_movimiento FOREIGN KEY (tipo_movimiento_id)
REFERENCES movimientos.tipo_movimiento (id) MATCH FULL
ON DELETE RESTRICT ON UPDATE RESTRICT;
-- ddl-end --
COMMENT ON CONSTRAINT fk_movimiento_tipo_movimiento ON movimientos.movimiento  IS 'Llave foranea a la tabla de tipo_movimiento';
-- ddl-end --
...
REFERENCES movimientos.movimiento (id) MATCH FULL
ON DELETE RESTRICT ON UPDATE RESTRICT;
-- ddl-end --
COMMENT ON CONSTRAINT fk_movimiento_detalle_movimiento ON movimientos.movimiento_detalle  IS 'Llave foranea a la tabla movimiento';
-- ddl-end --
